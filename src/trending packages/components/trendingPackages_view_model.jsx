...
const TrendingPackagesViewModel = ({ openedView, onClose, trendingPackage }) => {
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      title={
        trendingPackage.title ? `${trendingPackage.title} ( ${trendingPackage.duration} days )` : "trendingPackage Package"
      }
      centered
      size="xxl"
      styles={{
      ...
      >
        {trendingPackage ? (
          <>
            ...
            <CommonImageBannerComponent trendingPackage={trendingPackage}  />
            <Stack spacing="sm" className="text-[14px]">
              ...
              <CommonTripHighlightsViewComponent
                tripHighlightList={trendingPackage.tripHighlights}
              />
              ...
              <CommmonDestinationsViewComponent
                destinations={trendingPackage.destinationIds}
              />
              ...
              <CommonTravelThemesViewComponent
                travelThemes={trendingPackage.travelThemeIds}
              />
              ...
              <CommonItineraryViewComponent
                ...
                title={"Itinerary"}
                itineraryData={trendingPackage?.itinerary}
              />
              ...
              <CommonPackageRateViewComponent
                ...
                packageRateList={trendingPackage?.packageRate}
              />
              ...
              <CommonRichTextViewComponent
                ...
                title={"Inclusions"}
                data={trendingPackage?.inclusions}
              />
              ...
              <CommonRichTextViewComponent
                ...
                title={"Exclusions"}
                data={trendingPackage?.exclusions}
              />
              ...
              {/* <CommonHotelsViewComponent
                ...
                hotelList={trendingPackage?.hotels}
              /> */}
            </Stack>
          </>
        ) : (
          <Text c="dimmed">No Trending Package data available.</Text>
        )}
          <button
...
export default TrendingPackagesViewModel;
