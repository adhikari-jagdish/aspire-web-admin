...
const TrendingPackagesAddModel = ({
  opened,
  onClose,
  handleSubmit,
  packageList = [],
    ...
    >
      <div className="text-[15px]">
        <div className="flex items-center gap-10">
          <Select
          placeholder="Select Trending Package"
...
export default TrendingPackagesAddModel;
