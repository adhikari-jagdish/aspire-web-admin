          ...
          <>
            ...
            <Stack spacing="sm" className="text-[14px]">
              ...
              <CommonTripHighlightsViewComponent
                tripHighlightList={expedition.tripHighlights}
              />
              ...
              <CommmonDestinationsViewComponent
                destinations={expedition.destinationIds}
              />
              ...
              <CommonTravelThemesViewComponent
                travelThemes={expedition.travelThemeIds}
              />
              ...
              <CommonPackageRateViewComponent
                ...
                packageRateList={expedition?.packageRate}
              />
              ...
              <CommonRichTextViewComponent
                ...
                title={"Exclusions"}
                data={expedition?.exclusions}
              />

                    <CommonTitleComponent title={"Map"} />

              <CommonMapImageComponent expedition={expedition} />
...
export default ExpeditionsViewModel;
