...
const ExpeditionsView = ({columns, shouldShowDelete, shouldShowEdit,  onEditButtonClick,onDeleteButtonClick, onViewButtonClick}) => {
  ...
  return (
    <>
      <button
        onClick={() => nav('/expeditions/addExpeditionPackage')}
