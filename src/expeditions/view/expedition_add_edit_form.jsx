...
const ExpeditionsAddEditForm = ({
  ...
  useEffect(() => {
    if (isEditExpedition && opened) {
      setFormData({
        destinationId: expedition.destinationId || "",
        travelThemeId: expedition.travelThemeId || "",
        title: expedition.title || "",
        duration: expedition.duration || "",
        overview: expedition.overview || "",
        packageInclusions: expedition.packageInclusions || "",
        itinerary: expedition.itinerary,
        inclusions: expedition.inclusions || "",
        exclusions: expedition.exclusions || "",
        hotels: expedition.hotels || "",
        packageRate: expedition.packageRate || "",
        discount: expedition.discount || "",
        image: expedition.image || null,
      });
    } else {
...
export default ExpeditionsAddEditForm;
