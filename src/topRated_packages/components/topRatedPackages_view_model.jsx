...
const TopRatedPackagesViewModel = ({ openedView, onClose, topRatedPackage }) => {
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      title={
        topRatedPackage.title ? `${topRatedPackage.title} ( ${topRatedPackage.duration} days )` : "topRatedPackage Package"
      }
      centered
      size="xxl"
      styles={{
      ...
      >
        {topRatedPackage ? (
          <>
            ...
            <CommonImageBannerComponent topRatedPackage={topRatedPackage}  />
            <Stack spacing="sm" className="text-[14px]">
              ...
              <CommonTripHighlightsViewComponent
                tripHighlightList={topRatedPackage.tripHighlights}
              />
              ...
              <CommmonDestinationsViewComponent
                destinations={topRatedPackage.destinationIds}
              />
              ...
              <CommonTravelThemesViewComponent
                travelThemes={topRatedPackage.travelThemeIds}
              />
              ...
              <CommonItineraryViewComponent
                ...
                title={"Itinerary"}
                itineraryData={topRatedPackage?.itinerary}
              />
              ...
              <CommonPackageRateViewComponent
                ...
                packageRateList={topRatedPackage?.packageRate}
              />
              ...
              <CommonRichTextViewComponent
                ...
                title={"Inclusions"}
                data={topRatedPackage?.inclusions}
              />
              ...
              <CommonRichTextViewComponent
                ...
                title={"Exclusions"}
                data={topRatedPackage?.exclusions}
              />
              ...
              {/* <CommonHotelsViewComponent
                ...
                hotelList={topRatedPackage?.hotels}
              /> */}
            </Stack>
          </>
        ) : (
          <Text c="dimmed">No Top Rated Package data available.</Text>
        )}
          <button
...
export default TopRatedPackagesViewModel;
