...
const AdventuresView = ({columns, shouldShowDelete, shouldShowEdit,  onEditButtonClick,onDeleteButtonClick, onViewButtonClick}) => {
  ...
  return (
    <>
      <button
        onClick={() => nav('/adventures/addAdventurePackage')}
