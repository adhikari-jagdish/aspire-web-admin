...
const TrekkingsViewModel = ({ openedView, onClose, trekking }) => {
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      title={
        trekking.title ? `${trekking.title} ( ${trekking.duration} days )` : "trekking Package"
      }
      centered
      size="xxl"
      styles={{
      ...
      >
        {trekking ? (
          <>
            ...
            <CommonImageBannerComponent trekking={trekking}  />
            <Stack spacing="sm" className="text-[14px]">
              ...
              <CommonTripHighlightsViewComponent
                tripHighlightList={trekking.tripHighlights}
              />
              ...
              <CommmonDestinationsViewComponent
                destinations={trekking.destinationIds}
              />
              ...
              <CommonTravelThemesViewComponent
                travelThemes={trekking.travelThemeIds}
              />
              ...
              <CommonItineraryViewComponent
                ...
                title={"Itinerary"}
                itineraryData={trekking?.itinerary}
              />
              ...
              <CommonPackageRateViewComponent
                ...
                packageRateList={trekking?.packageRate}
              />
              ...
              <CommonRichTextViewComponent
                ...
                title={"Exclusions"}
                data={trekking?.exclusions}
              />
              <CommonTitleComponent title={"Map"} />

              <CommonMapImageComponent trekking={trekking} />
            </Stack>
          </>
        ) : (
