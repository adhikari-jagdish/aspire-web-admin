...
const PeakClimbingsView = ({columns, shouldShowDelete, shouldShowEdit,  onEditButtonClick,onDeleteButtonClick, onViewButtonClick}) => {
  ...
  return (
    <>
      <button
        onClick={() => nav('/peakClimbings/addPeakClimbingPackage')}
...
export default PeakClimbingsView;
